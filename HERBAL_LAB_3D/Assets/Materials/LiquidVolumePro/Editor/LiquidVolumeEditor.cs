...
namespace LiquidVolumeFX {
    ...
    public class LiquidVolumeEditor : Editor {
        ...
        SerializedProperty level, levelMultipler, liquidColor1, liquidColor2, liquidScale1, liquidScale2, alpha, finalAlphaMultiplier, emissionColor, emissionBrightness, useLightColor, directionalLight;
